...
public class ORDERLIST18 {
  ...
  @Test
  public void testORDERLIST18() throws Exception {
    ...
    driver.findElement(By.id("k-8511d0f0-506e-4967-bdac-92236f8595bf")).click();
    driver.findElement(By.xpath("//input[@type='checkbox']")).click();
    driver.findElement(By.xpath("//li[@id='option-1539a368-a542-4e82-83fc-36c188b8c44e-8']/input")).click();

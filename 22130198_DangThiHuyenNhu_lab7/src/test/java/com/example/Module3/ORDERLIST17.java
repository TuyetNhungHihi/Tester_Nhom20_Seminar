...
public class ORDERLIST17 {
  ...
  @Test
  public void testORDERLIST17() throws Exception {
    ...
    driver.findElement(By.xpath("//li[@id='option-b33284a1-b563-4ff2-9e3a-56dd7a41f393-7']/input")).click();
